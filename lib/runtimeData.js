const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/Noob_Advanture_3_Web_VKontakte.loader.js",
        dataURL: "bin/Noob_Advanture_3_Web_VKontakte.data.unityweb",
        frameworkURL: "bin/Noob_Advanture_3_Web_VKontakte.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/Noob_Advanture_3_Web_VKontakte.wasm.unityweb",
        symbolsURL: "",
        streamingURL: "streaming",

        // Visual information.
        logoType: "None",
        iconTextureName: "logo_256.png",
