const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/Moon-Ants_Web_VKontakte.loader.js",
        dataURL: "bin/Moon-Ants_Web_VKontakte.data.unityweb",
        frameworkURL: "bin/Moon-Ants_Web_VKontakte.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/Moon-Ants_Web_VKontakte.wasm.unityweb",
        symbolsURL: "",
